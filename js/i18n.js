...
const translations = {
  ...
  en: {
    ...
    'download.cr.priceSub':   'once, not monthly · Universal Purchase on Mac, iPad, iPhone',
    ...
    'download.faq.a3.p1':         '$19.99 is a one-time purchase. Buy once, install on Mac, iPad, and iPhone with the same payment, and use it forever. No subscription, no in-app purchases, no upsells. It’s priced like a tool you’ll use for years — by an indie developer who’d rather make one good app than nag you to renew it month after month.',
    ...
    'privacy.short.p':         'ContinuousReader and JustReader do not collect, analyze, or sell any personal data. <strong>No analytics, no telemetry, no tracking, no advertising.</strong> Your reading habits stay with you — on your own devices, in your own iCloud account if you turn on sync, and briefly in transit between your devices when sync hands a fresh reading position from one to another. Nothing else, nowhere else.',

...
const translations = {
  ...
  en: {
    ...
    'features.s1.modes.p2':       'Switch to <strong>Page</strong> mode for a paginated experience with animated or instant page turns and page separators. On Mac and iPad (in landscape), <strong>Two pages</strong> mode renders a classic book spread. All three modes preserve your exact position when switching.',
    ...
    'features.s1.fullscreen.p1':  'Tap the center of the reading area to hide the bottom bar and enter fullscreen. The top safe area is ignored so content extends under the Dynamic Island or camera housing. Tap the center again to exit. The mode auto-exits when you open settings, search, or the side panel.',

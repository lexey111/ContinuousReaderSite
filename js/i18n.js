...
const translations = {
  ...
  en: {
    ...
    'index.s4.p3':      'Five core palettes — Neutral, Ochre, Celestial, Lime, Rose — each with seven tonal variations: from a pure-white extreme on the left, through five mid tones, to a pure-black extreme on the right. Plus two featured themes for the old-school crowd: <em>Typewriter</em> in ivory and dark brown, and <em>Terminal</em> in white monospace on deep blue (if you recognize the palette — <em>you already know why it’s there</em>). Three custom slots where the colors are yours. <strong>Forty-one variants in total.</strong>',
    ...
    'features.s1.themes.li2':     '<strong>Featured</strong>Typewriter (ivory + dark brown, locked to American Typewriter) and Terminal (white monospace on deep blue, locked to Menlo / Courier New, Norton Commander homage). Both come with their own independent typography and layout settings.',
  ...
  ru: {
    ...
    'index.s4.p3':      'Пять основных палитр — Neutral, Ochre, Celestial, Lime, Rose — каждая с семью тональными вариациями: чисто-белый экстрим слева, пять средних тонов посередине и чисто-чёрный экстрим справа. Плюс две особые темы для любителей олдскула: <em>Typewriter</em> в цвете слоновой кости и тёмно-коричневом и <em>Terminal</em> — белый моноширинный на глубоком синем (если палитра кажется знакомой — <em>да, вы не ошиблись</em>). Три кастомных слота под ваши цвета. <strong>Всего сорок один вариант.</strong>',

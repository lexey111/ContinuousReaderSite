...
const translations = {
  ...
  en: {
    ...
    'common.finalCta.subtitle': 'Two apps. Free or full. One download away.',
    ...
    'index.s5.p1':      'Highlight a word. The translation appears in a panel at the bottom of the screen — not as a popup that covers the text, not as a modal you have to dismiss. Keep reading. The translation updates as you select.',
    ...
    'index.s6.h2':      'Thousands of books. <em>All yours.</em>',
    ...
    'index.s8.cr.desc':  'A full reading workspace. Build a library of thousands of books. Sync your position, bookmarks, and reading settings across Mac, iPad, and iPhone. OPDS catalogs. Bookmarks, notes, statistics. Every feature, on every device, forever.',
    ...
    'download.cr.desc':       'Full reading workspace. Library with thousands of books. iCloud sync across <strong>every Apple device you own</strong>. Bookmarks, notes, translation statistics, reading stats. OPDS catalogs with watchers. Backup and restore. Every feature, on every device.',
    ...
    'download.faq.a6.p4':         'On the free 5 GB tier (shared with iCloud backups, photos, and other files), a modest library of a few hundred books fits comfortably. For thousands of books — especially illustrated ones — an iCloud+ plan (50 GB for about $1 a month, or 200 GB for around $3) is worth considering.',
